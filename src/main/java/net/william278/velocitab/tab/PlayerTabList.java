            ...
            plugin.getServer().getScheduler()
                    .buildTask(plugin, () -> {
                        ...
                        for (final TabPlayer player : tabPlayers) {
                            ...
                            if (group.onlyListPlayersInSameServer() &&
                                    !serverName.equals(player.getPlayer().getCurrentServer().map(ServerConnection::getServerInfo).map(ServerInfo::getName).orElse(""))
                            ) {
                                continue;
                            }
